...
describe('Script', function() {
  ...
  describe('#toString', function() {
    ...
    it('should output this known script as ASM', function() {
      ...
      script
        .toASM()
        .should.equal('OP_DUP OP_HASH160 f4c03610e60ad15100929cc23da2f3a799af1725 OP_EQUALVERIFY OP_CHECKSIG');
    });
  ...
  describe('#isDataOut', function() {
    ...
    it('validates that this two part OP_RETURN is standard', function() {
      Script.fromASM('OP_RETURN 026d02 0568656c6c6f')
        .isDataOut()
        .should.equal(true);
    });
  ...
  describe('#isPushOnly', function() {
    it("should know these scripts are or aren't push only", function() {
      Script('OP_NOP 1 0x01')
        .isPushOnly()
        .should.equal(false);
      Script('OP_0')
        .isPushOnly()
        .should.equal(true);
      Script('OP_0 OP_RETURN')
        .isPushOnly()
        .should.equal(false);
      Script('OP_PUSHDATA1 5 0x1010101010')
        .isPushOnly()
        .should.equal(true);
      Script('OP_PUSHDATA2 5 0x1010101010')
        .isPushOnly()
        .should.equal(true);
      Script('OP_PUSHDATA4 5 0x1010101010')
        .isPushOnly()
        .should.equal(true);
  ...
  describe('#add and #prepend', function() {
    it('should add these ops', function() {
      Script()
        ...
        .add(186)
        .toString()
        .should.equal('0x01 0x0a OP_CHECKDATASIG');
      Script()
        .add(1000)
        .toString()
        .should.equal('0x03e8');
  ...
  describe('#buildPublicKeyHashOut', function() {
    it('should create script from livenet address', function() {
      ...
      s.toAddress()
        .toString()
        .should.equal('bitcoincash:qrk2ulgf99rm0mjfnr39f2jgjqxjd5kwr5rfyamw2k');
    });
    it('should create script from testnet address', function() {
      ...
      s.toAddress()
        .toString()
        .should.equal('bchtest:qzukhqt0x796hv07tpdhheaze5twhxdnuslxfpzagp');
    });
  ...
  describe('toAddress', function() {
    ...
    it('use the inherited network', function() {
      ...
      script
        .toAddress()
        .toString()
        .should.equal(liveAddress.toString());
    ...
    it('works for p2pkh output', function() {
      ...
      script
        .toAddress()
        .toString()
        .should.equal('bitcoincash:qrywzxcwkrf265mzmz20qjyssdql5cdkuyz47850l7');
    });
    it('works for p2pkh input', function() {
      ...
      s2.toAddress()
        .toString()
        .should.equal('bitcoincash:qprjfgyvctp82eddvwrup69dvggw63afzg0rfyyvtn');
    });
    ...
    it('works for p2sh output', function() {
      ...
      script
        .toAddress()
        .toString()
        .should.equal('bitcoincash:pzva9yz34uxzntwtjpqqx36jhwnamce7x5whc9x70h');
    });
    it('works for p2sh input', function() {
      ...
      script
        .toAddress()
        .toString()
        .should.equal('bitcoincash:pz30sxmypnge5lv0eyshlt0w5jzu5axu3sl4r37aun');
    });
  ...
  describe('#getSignatureOperationsCount', function() {
    ...
    it('should return zero for empty scripts', function() {
      Script()
        .getSignatureOperationsCount(false)
        .should.equal(0);
      Script()
        .getSignatureOperationsCount(true)
        .should.equal(0);
    });
